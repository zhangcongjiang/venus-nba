...
if __name__ == '__main__':
    ...
    usa_players = ['Paolo Banchero', 'Austin Reaves', 'Josh Hart', 'Cameron Johnson', 'Walker Kessler', 'Mikal Bridges',
                   ...
                   'Jalen Brunson']
    players = get_sql("select player_name from public.player_active where draft_year =2022;")
    ...
    file_name = f"F:\\notebooks\\其他\\draft\\{today}_2022.md"
    with open(file_name, "w", encoding="utf-8") as file:
        ...
        for data in reversed(sorted_datas):
            ...
            ImageUtils().draw_text(data.get('code'), 2022, data.get('this_hit_rate').replace("，", " | "), (
                '┏',
